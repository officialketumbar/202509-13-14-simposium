...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyCJvqm0NdUr72fYUdwX_EyJlk-n-11f1ns7qTkIj5EErgwKhxYUzAG0A4FZXK6HNXl/exec';
...
async function checkNIK() {
  ...
  try {
    const endpoint = `${https://script.google.com/macros/s/AKfycbyCJvqm0NdUr72fYUdwX_EyJlk-n-11f1ns7qTkIj5EErgwKhxYUzAG0A4FZXK6HNXl/exec}?action=checkNIK&nik=${nik}`;
...
document.getElementById('registrationForm').addEventListener('submit', async (e) => {
  ...
  showLoading();
  try {
    const res = await fetch(https://script.google.com/macros/s/AKfycbyCJvqm0NdUr72fYUdwX_EyJlk-n-11f1ns7qTkIj5EErgwKhxYUzAG0A4FZXK6HNXl/exec, {
      method: 'POST',
