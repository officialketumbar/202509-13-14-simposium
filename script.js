...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxYh8CMEjRRHBdvGSZB1RBZt_oyFkQ1AXV5sXIUV5ogLknJSFe9_XmOFfDZcAZ0QYac/exec'; // Ganti dengan URL Google Apps Script Anda
...
async function checkNIK() {
    ...
    try {
        const response = await fetch(`${https://script.google.com/macros/s/AKfycbxYh8CMEjRRHBdvGSZB1RBZt_oyFkQ1AXV5sXIUV5ogLknJSFe9_XmOFfDZcAZ0QYac/exec}?action=checkNIK&nik=${nik}`);
